...
from  awscdk_resources_mongodbatlas import ( AdvancedRegionConfig, AdvancedReplicationSpec,Specs, AccessListDefinition, IpAccessListProps, ProjectProps, ClusterProps, AtlasBasic, DatabaseUserProps )
...
class AwsMongodbAtlasCreateStack(Stack):
  ...
  def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
    ...
    atlas_basic_l3 = AtlasBasic(self, "AtlasBasic-py-l3",
                                      ...
                                      db_user_props=DatabaseUserProps(username=username,password=password),
    ...
    self.Atlas_URI = "mongodb+srv://" + username + ":" + password + "@" + atlas_basic_l3.m_cluster.connection_strings.standard 
    
    #"mongodb+srv://" + USERNAME + ":" + PASSWORD + "@" + CLUSTER_HOST
